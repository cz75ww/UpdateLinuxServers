...
Chk_Diskstable () #Disks_Table
{
   echo DisksTable_chk_START:
   fdisk -l | grep Disk | egrep -v '(mapper|identifier|dos)'
   echo DisksTable_chk_END:
}
...
echo ""
echo " Linux Operating System Checklist v2.00"
